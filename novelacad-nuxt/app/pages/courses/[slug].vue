...
const allCourses = [
  { slug: 'solar-design-installation', name: 'Solar Design & Installation', img: 'solar install.png', duration: '3-12 Months',
  ...
  { slug: 'solarpreneurship', name: 'Solarpreneurship', img: 'solarprenuer.png', duration: '3-12 Months',
  ...
  { slug: 'repair-maintenance', name: 'Repair & Maintenance', img: 'repair.png', duration: '3-12 Months',
  ...
  { slug: 'hse-management', name: 'HSE Management', img: 'hse.png', duration: '3-12 Months',
  ...
  { slug: 'research-automation', name: 'Practical Research & Automation', img: 'robotics.png', duration: '3-12 Months',
    desc: 'Learn to automate processes and conduct data-driven research using modern technological tools.',
    about: 'This modern course introduces you to the essentials of advanced research methodologies and process automation. You will learn data collection strategies, process mapping, and how to deploy automation tools to optimise workflows and generate actionable insights.',
    outcomes: [
      'Understand core principles of quantitative and qualitative research',
      'Design, implement, and orchestrate automated workflows',
      'Analyse large datasets to extract meaningful insights',
      'Apply intelligent automation to solve real-world business problems',
      'Present and validate data-driven research projects',
    ],
    audience: 'Open to beginners with or without a technical background. Ideal for students, analysts, and professionals looking to optimise processes through research and automation.' },
  { slug: 'web-development', name: 'Web Development', img: 'webdev.png', duration: '3-12 Months',
    desc: 'Design and build modern, responsive websites using industry-standard tools.',
    about: 'This practical course covers everything needed to become a proficient web developer. You will learn front-end and back-end modern web technologies, how to build responsive layouts, and how to deploy your applications to the web.',
    outcomes: [
      'Build responsive and interactive websites using HTML, CSS, and modern JavaScript',
      'Understand and use web frameworks and libraries effectively',
      'Create and manage backend services and databases',
      'Deploy full-stack web applications to cloud servers',
      'Implement SEO best practices and web performance optimization',
    ],
    audience: 'Ideal for beginners wanting to start a career in tech, as well as designers and IT professionals looking to upgrade their web development skills.' },
  { slug: 'app-development', name: 'App Development', img: 'app-dev.png', duration: '3-12 Months',
  ...
  { slug: 'digital-marketing', name: 'Digital Marketing', img: 'digital.png', duration: '3-12 Months',
